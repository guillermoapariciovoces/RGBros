...
entity test_interface is
    ...
    port(
         ...
         digctrl : out std_logic_vector (7 downto 0);             --Selección de ánodo en la placa -> Importante NEGADO
...
--       );
    ...
    digctrl <= not(ciclo_selection);      --recordemos que los ánodos en la placa van negados y eso
